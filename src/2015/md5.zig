...
inline fn roundParam(a: usize, b: usize, c: usize, d: usize, k: usize, s: u32, t: u32) RoundParam {
    return RoundParam{
        .a = a,
        .b = b,
        .c = c,
...
pub const Md5 = struct {
    ...
    inline fn round(d: *Self, b: *const [64]u8) void {
        ...
        inline for (round1) |r| {
            ...
            v[r.a] = v[r.a] +% ((v[r.d] & v[r.b]) + (~v[r.d] & v[r.c])) +% r.t +% s[r.k];
            v[r.a] = v[r.b] +% math.rotl(u32, v[r.a], r.s);
        }
